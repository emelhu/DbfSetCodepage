...
namespace DbfSetCodepage
{
  ...
  class Program
  {
    ...
    {
      Console.WriteLine("**** DBF Set Codepage ****  (c) eMeL [www.emel.hu] **** FreeWare ****");
      Console.WriteLine();
    ...
    static void DispUsage()
    {
      ...
      Console.WriteLine("  DbfSetCodepage fileName/searchPattern codePageName ");
      Console.WriteLine();
      Console.WriteLine("  Valid codepage codes:\n  " + String.Join(",", Enum.GetNames(typeof(DbfSetCodePage.CodepageCodes))));
      Console.WriteLine();
    }
  }
